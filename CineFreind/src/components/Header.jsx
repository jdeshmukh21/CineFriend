...
const Header = () => {
  ...
  const [menuVisible, setMenuVisible] = useState( JSON.parse(localStorage.getItem("darkMode")) || false);
  ...
  return (
    <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-1">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
        ...
        >
          <img src={Logo} className="h-12 w-12" alt="cinefreind Logo" />
          <span className="self-center text-2xl font-semibold dark:text-white">
            CineFriend
          </span>
        </NavLink>
        <div id="mobile-nav" className="flex md:order-2 space-x-3">
          <button
          ...
          <div className="relative hidden md:block">
            ...
            <form onSubmit={handleSubmit}>
              <input
                ...
                id="search-navbar-md"
                name="search"
                className="block w-40 p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Search..."
                autoComplete="off"
              />
            </form>
          ...
          <div
            id="nav-links"
            className={`relative ${hidden ? "hidden" : "block"} md:hidden`}
          >
            <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
              <svg
                className="w-4 h-4 text-gray-500 dark:text-gray-400"
